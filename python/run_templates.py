...
parser.add_option('--fix_Afb', 	  type='string', action='store', default='yes', dest='fix_Afb')
parser.add_option('--fix_mu', 	  type='string', action='store', default='yes', dest='fix_mu')
parser.add_option('--fix_d', 	  type='string', action='store', default='yes', dest='fix_d')
