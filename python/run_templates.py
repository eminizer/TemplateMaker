...
parser.add_option('--Rntmj',  type='float', action='store', default=1.0, dest='Rntmj', 	help='Rntmj scale factor value')
...
parser.add_option('--Rntmj_sigma', 	type='float',  action='store', default=0.2,		 dest='Rntmj_sigma',  help='Rntmj scale factor uncertainty')
...
parser.add_option('--fix_Rntmj',  type='string', action='store', default='no', dest='fix_Rntmj')
...
rntmj  = ('Rntmj', options.Rntmj, options.Rntmj_sigma, options.fix_Rntmj.lower()=='yes')
...
fit_parameter_tuple = (rqqbar,rbck,rntmj,afb,mu,d)
...
templates = Template_Group(fit_parameter_tuple,options.sum_charges.lower()=='yes',options.include_mu.lower()=='yes',options.include_el.lower()=='yes',
							options.include_PDF.lower()=='yes',options.include_JEC.lower()=='yes',options.include_sss.lower()=='yes')
print 'Done'
#Open the input file
input_file_path =''
