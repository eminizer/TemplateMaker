...
'y':array('d',[0.00,0.05,0.10,0.14,0.18,0.70]),
'z':array('d',[300.000000,387.021698,422.189148,453.705322,485.331299,521.120544,567.812988,645.619995,3000.000000])},
...
'y':array('d',[0.00,0.05,0.10,0.14,0.18,0.70]),
'z':array('d',[300.000000,387.527710,422.055054,453.163574,484.985779,520.940552,567.107788,644.709045,3000.000000])},
...
'y':array('d',[0.00,0.05,0.10,0.14,0.18,0.70]),
'z':array('d',[300.000000,401.989899,445.585144,487.694458,538.136597,616.580322,3000.000000])},
...
'y':array('d',[0.00,0.05,0.10,0.14,0.18,0.70]),
'z':array('d',[300.000000,401.765839,445.523468,487.937897,538.728149,616.710449,3000.000000])},
...
't2_muplus_WJets_CR':{'x':array('d',[-1.0,1.0]),
'y':array('d',[0.0,0.7]),
'z':array('d',[300.000000,661.994019,828.922485,3000.000000])},
't2_muminus_WJets_CR':{'x':array('d',[-1.0,1.0]),
'y':array('d',[0.0,0.7]),
'z':array('d',[300.000000,661.766418,828.731689,3000.000000])},
't2_elplus_WJets_CR':{'x':array('d',[-1.0,1.0]),
'y':array('d',[0.0,0.7]),
'z':array('d',[300.0,3000.0])},
't2_elminus_WJets_CR':{'x':array('d',[-1.0,1.0]),
'y':array('d',[0.0,0.7]),
'z':array('d',[300.0,3000.0])},
...
't1_muplus_WJets_CR':{'x':array('d',[-1.0,1.0]),
'y':array('d',[0.0,0.7]),
'z':array('d',[500.000000,941.432434,3000.000000])},
't1_muminus_WJets_CR':{'x':array('d',[-1.0,1.0]),
'y':array('d',[0.0,0.7]),
'z':array('d',[500.000000,942.248840,3000.000000])},
't1_elplus_WJets_CR':{'x':array('d',[-1.0,1.0]),
'y':array('d',[0.0,0.7]),
'z':array('d',[500.000000,3000.000000])},
't1_elminus_WJets_CR':{'x':array('d',[-1.0,1.0]),
'y':array('d',[0.0,0.7]),
'z':array('d',[500.000000,3000.000000])},
}
...
all_channels['t2_muplus_SR']  = Channel('t2_muplus_SR','eventTopology==2 && lepflavor==1 && lep_Q>0 && fullselection==1',10,-1.,1.,4,0.,0.20,0.7,4,300.,3000.,50.)
all_channels['t2_muminus_SR'] = Channel('t2_muminus_SR','eventTopology==2 && lepflavor==1 && lep_Q<0 && fullselection==1',10,-1.,1.,4,0.,0.20,0.7,4,300.,3000.,50.)
all_channels['t2_elplus_SR']  = Channel('t2_elplus_SR','eventTopology==2 && lepflavor==2 && lep_Q>0 && fullselection==1',10,-1.,1.,4,0.,0.20,0.7,2,300.,3000.,5.)
all_channels['t2_elminus_SR'] = Channel('t2_elminus_SR','eventTopology==2 && lepflavor==2 && lep_Q<0 && fullselection==1',10,-1.,1.,4,0.,0.20,0.7,2,300.,3000.,4.)
all_channels['t3_muplus_SR']  = Channel('t3_muplus_SR','eventTopology==3 && lepflavor==1 && lep_Q>0 && fullselection==1',12,-1.,1.,9,0.,0.18,0.7,16,300.,3000.,10.)
all_channels['t3_muminus_SR'] = Channel('t3_muminus_SR','eventTopology==3 && lepflavor==1 && lep_Q<0 && fullselection==1',12,-1.,1.,9,0.,0.18,0.7,16,300.,3000.,10.)
all_channels['t3_elplus_SR']  = Channel('t3_elplus_SR','eventTopology==3 && lepflavor==2 && lep_Q>0 && fullselection==1',12,-1.,1.,9,0.,0.18,0.7,12,300.,3000.,10.)
all_channels['t3_elminus_SR'] = Channel('t3_elminus_SR','eventTopology==3 && lepflavor==2 && lep_Q<0 && fullselection==1',12,-1.,1.,9,0.,0.18,0.7,12,300.,3000.,10.)#118.)
#charge summed
...
#charge separated
all_channels['t1_muplus_WJets_CR']  = Channel('t1_muplus_WJets_CR','eventTopology==1 && lepflavor==1 && lep_Q>0 && wjets_cr_selection==1',8,-1.,1.,2,0.,0.30,0.7,4,500.,3000.,35.,25.)
all_channels['t1_muminus_WJets_CR'] = Channel('t1_muminus_WJets_CR','eventTopology==1 && lepflavor==1 && lep_Q<0 && wjets_cr_selection==1',8,-1.,1.,2,0.,0.30,0.7,4,500.,3000.,25.,15.)
...
all_channels['t2_muplus_WJets_CR']  = Channel('t2_muplus_WJets_CR','eventTopology==2 && lepflavor==1 && lep_Q>0 && wjets_cr_selection==1',10,-1.,1.,4,0.,0.20,0.7,6,300.,3000.,50.)
all_channels['t2_muminus_WJets_CR'] = Channel('t2_muminus_WJets_CR','eventTopology==2 && lepflavor==1 && lep_Q<0 && wjets_cr_selection==1',10,-1.,1.,4,0.,0.20,0.7,6,300.,3000.,25.)
all_channels['t2_elplus_WJets_CR']  = Channel('t2_elplus_WJets_CR','eventTopology==2 && lepflavor==2 && lep_Q>0 && wjets_cr_selection==1',10,-1.,1.,4,0.,0.20,0.7,2,300.,3000.,5.)
all_channels['t2_elminus_WJets_CR'] = Channel('t2_elminus_WJets_CR','eventTopology==2 && lepflavor==2 && lep_Q<0 && wjets_cr_selection==1',10,-1.,1.,4,0.,0.20,0.7,2,300.,3000.,4.)
#charge summed
