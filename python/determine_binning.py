...
'y':array('d',[0.000000,0.026134,0.046960,0.062639,0.078180,0.096253,0.114598,0.134829,0.154853,0.180000,0.600000]),
'z':array('d',[300.000000,378.895691,408.830780,434.848755,459.787598,485.335449,513.417725,547.018005,592.737915,671.119141,2000.000000])},
...
'y':array('d',[0.000000,0.022669,0.039310,0.054728,0.069610,0.083557,0.103297,0.119977,0.142007,0.180000,0.600000]),
'z':array('d',[300.000000,379.393311,408.800964,434.975220,459.419983,484.988464,513.129150,546.618530,592.012817,670.119385,2000.000000])},
...
'z':array('d',[300.000000,563.116943,658.737122,753.599487,887.586365,3000.000000])},
...
'z':array('d',[300.000000,566.139160,659.887146,753.587402,881.927979,3000.000000])},
't2_elplus_SR':{'x':array('d',[-1.000000,-0.600000,-0.400000,-0.200000,0.000000,0.200000,0.400000,0.600000,1.000000]),
'y':array('d',[0.000000,0.060727,0.114594,0.156142,0.200000,0.600000]),
'z':array('d',[300.000000,614.646851,782.179077,902.415039,1087.048340,3000.000000])},
't2_elminus_SR':{'x':array('d',[-1.000000,-0.600000,-0.400000,-0.200000,0.000000,0.200000,0.400000,0.600000,1.000000]),
'y':array('d',[0.000000,0.040815,0.094567,0.168345,0.200000,0.600000]),
'z':array('d',[300.000000,619.622681,792.935547,929.938416,1097.187256,3000.000000])},
...
'y':array('d',[0.000000,0.067848,0.107569,0.150595,0.200000,0.600000]),
'z':array('d',[300.000000,607.466248,689.666931,787.836426,946.797485,3000.000000])},
...
'z':array('d',[300.000000,604.272949,689.435730,787.458923,945.027710,3000.000000])},
't2_elplus_WJets_CR':{'x':array('d',[-1.000000,-0.600000,-0.400000,-0.200000,0.000000,0.200000,0.400000,0.600000,1.000000]),
'y':array('d',[0.000000,0.062300,0.096723,0.139126,0.200000,0.600000]),
'z':array('d',[300.000000,718.649536,851.163025,999.153748,1277.408813,3000.000000])},
't2_elminus_WJets_CR':{'x':array('d',[-1.000000,-0.600000,-0.400000,-0.200000,0.000000,0.200000,0.400000,0.600000,1.000000]),
'y':array('d',[0.000000,0.084940,0.149415,0.151976,0.200000,0.600000]),
'z':array('d',[300.000000,710.085571,843.432617,1000.938721,1283.019775,3000.000000])},
#type-1 signal region
't1_muplus_SR':{'x':array('d',[-1.000000,-0.500000,-0.250000,0.000000,0.250000,0.500000,1.000000]),
'y':array('d',[0.000000,0.128332,0.300000,0.600000]),
'z':array('d',[500.000000,1107.548462,3000.000000])},
...
'z':array('d',[500.000000,942.248840,3000.000000])},
't1_elplus_WJets_CR':{'x':array('d',[-1.000000,-0.500000,-0.250000,0.000000,0.250000,0.500000,1.000000]),
'y':array('d',[0.000000,0.141030,0.300000,0.600000]),
'z':array('d',[500.000000,1116.568848,3000.000000])},
't1_elminus_WJets_CR':{'x':array('d',[-1.000000,-0.500000,-0.250000,0.000000,0.250000,0.500000,1.000000]),
'y':array('d',[0.000000,0.145156,0.300000,0.600000]),
'z':array('d',[500.000000,1133.657349,3000.000000])},
}
...
class Channel(object) :
	...
	def getCodeLineList(self) :
		...
		for i in range(len(self._best_fit_x_bins)) :
			...
			if i<len(self._best_fit_x_bins)-1 :
				x_bins_string+=','
			else :
				x_bins_string+='])'
		#y bins
		...
		for i in range(len(self._best_fit_y_bins)) :
			...
			if i<len(self._best_fit_y_bins)-1 :
				y_bins_string+=','
			else :
				y_bins_string+='])'
		#z bins
		...
		for i in range(len(self._best_fit_z_bins)) :
			...
			if i<len(self._best_fit_z_bins)-1 :
				z_bins_string+=','
			else :
				z_bins_string+='])'
...
#signal region
#charge separated
#all_channels['t1_muplus_SR']  = Channel('t1_muplus_SR','eventTopology==1 && lepflavor==1 && lep_Q>0 && fullselection==1',8,-1.,1.,2,0.,0.30,0.7,2,500.,3000.,100.,45.)
#all_channels['t1_muminus_SR'] = Channel('t1_muminus_SR','eventTopology==1 && lepflavor==1 && lep_Q<0 && fullselection==1',8,-1.,1.,2,0.,0.30,0.7,2,500.,3000.,55.,45.)
#all_channels['t1_elplus_SR']  = Channel('t1_elplus_SR','eventTopology==1 && lepflavor==2 && lep_Q>0 && fullselection==1',8,-1.,1.,2,0.,0.30,0.7,2,500.,3000.,45.,35.)
#all_channels['t1_elminus_SR'] = Channel('t1_elminus_SR','eventTopology==1 && lepflavor==2 && lep_Q<0 && fullselection==1',8,-1.,1.,2,0.,0.30,0.7,2,500.,3000.,25.,25.)
all_channels['t2_muplus_SR']  = Channel('t2_muplus_SR','eventTopology==2 && lepflavor==1 && lep_Q>0 && fullselection==1',10,-1.,1.,4,0.,0.20,0.7,2,300.,3000.,50.)
all_channels['t2_muminus_SR'] = Channel('t2_muminus_SR','eventTopology==2 && lepflavor==1 && lep_Q<0 && fullselection==1',10,-1.,1.,4,0.,0.20,0.7,2,300.,3000.,50.)
#all_channels['t2_elplus_SR']  = Channel('t2_elplus_SR','eventTopology==2 && lepflavor==2 && lep_Q>0 && fullselection==1',10,-1.,1.,4,0.,0.20,0.7,5,300.,3000.,5.)
#all_channels['t2_elminus_SR'] = Channel('t2_elminus_SR','eventTopology==2 && lepflavor==2 && lep_Q<0 && fullselection==1',10,-1.,1.,4,0.,0.20,0.7,5,300.,3000.,4.)
all_channels['t3_muplus_SR']  = Channel('t3_muplus_SR','eventTopology==3 && lepflavor==1 && lep_Q>0 && fullselection==1',12,-1.,1.,9,0.,0.18,0.7,8,300.,3000.,10.)
all_channels['t3_muminus_SR'] = Channel('t3_muminus_SR','eventTopology==3 && lepflavor==1 && lep_Q<0 && fullselection==1',12,-1.,1.,9,0.,0.18,0.7,8,300.,3000.,10.)
all_channels['t3_elplus_SR']  = Channel('t3_elplus_SR','eventTopology==3 && lepflavor==2 && lep_Q>0 && fullselection==1',12,-1.,1.,9,0.,0.18,0.7,6,300.,3000.,10.)
all_channels['t3_elminus_SR'] = Channel('t3_elminus_SR','eventTopology==3 && lepflavor==2 && lep_Q<0 && fullselection==1',12,-1.,1.,9,0.,0.18,0.7,6,300.,3000.,10.)#118.)
#charge summed
#all_channels['t1_mu_SR']  = Channel('t1_mu_SR','eventTopology==1 && lepflavor==1 && fullselection==1',6,-1.,1.,3,0.,0.7,2,500.,3000.,100.,45.)
#all_channels['t1_el_SR']  = Channel('t1_el_SR','eventTopology==1 && lepflavor==2 && fullselection==1',6,-1.,1.,3,0.,0.7,2,500.,3000.,45.,35.)
...
#charge separated
all_channels['t1_muplus_WJets_CR']  = Channel('t1_muplus_WJets_CR','eventTopology==1 && lepflavor==1 && lep_Q>0 && wjets_cr_selection==1',8,-1.,1.,2,0.,0.30,0.7,2,500.,3000.,35.,25.)
all_channels['t1_muminus_WJets_CR'] = Channel('t1_muminus_WJets_CR','eventTopology==1 && lepflavor==1 && lep_Q<0 && wjets_cr_selection==1',8,-1.,1.,2,0.,0.30,0.7,2,500.,3000.,25.,15.)
#all_channels['t1_elplus_WJets_CR']  = Channel('t1_elplus_WJets_CR','eventTopology==1 && lepflavor==2 && lep_Q>0 && wjets_cr_selection==1',8,-1.,1.,2,0.,0.30,0.7,2,500.,3000.,15.,25.)
#all_channels['t1_elminus_WJets_CR'] = Channel('t1_elminus_WJets_CR','eventTopology==1 && lepflavor==2 && lep_Q<0 && wjets_cr_selection==1',8,-1.,1.,2,0.,0.30,0.7,2,500.,3000.,25.,8.)
all_channels['t2_muplus_WJets_CR']  = Channel('t2_muplus_WJets_CR','eventTopology==2 && lepflavor==1 && lep_Q>0 && wjets_cr_selection==1',10,-1.,1.,4,0.,0.20,0.7,3,300.,3000.,50.)
all_channels['t2_muminus_WJets_CR'] = Channel('t2_muminus_WJets_CR','eventTopology==2 && lepflavor==1 && lep_Q<0 && wjets_cr_selection==1',10,-1.,1.,4,0.,0.20,0.7,3,300.,3000.,25.)
#all_channels['t2_elplus_WJets_CR']  = Channel('t2_elplus_WJets_CR','eventTopology==2 && lepflavor==2 && lep_Q>0 && wjets_cr_selection==1',10,-1.,1.,4,0.,0.20,0.7,5,300.,3000.,5.)
#all_channels['t2_elminus_WJets_CR'] = Channel('t2_elminus_WJets_CR','eventTopology==2 && lepflavor==2 && lep_Q<0 && wjets_cr_selection==1',10,-1.,1.,4,0.,0.20,0.7,5,300.,3000.,4.)
#charge summed
